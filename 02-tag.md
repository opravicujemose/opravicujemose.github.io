...
{% assign character_tags = "Artur Dent, Ford Prefect, Zaphod Beeblebrox, Fenchurch, Tricia McMillan, Trillian,  gospod Prosser, Random Dent, Slartibartfast, Ovečeni Velepotež, Hillman Hunter, Marvin, Rob McKenna, Vogoni, Thor" | split: ", " %}
